...
public class BinaryDecoder {
    fileprivate(set) public var data: [UInt8]
...
public extension BinaryDecoder {
    ...
    func decode(_ type: Float.Type) throws -> Float {
        let rawValue = try decode(UInt32.self)
        let data = Int(CFSwapInt32LittleToHost(rawValue))
        var mantissa = Int32(data & 0x00FFFFFF)
        let exponent = Int8(bitPattern: UInt8(data >> 24))
        ...
        return Float32(mantissa) * Float32(magnitude)
    }
